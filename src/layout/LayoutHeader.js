          ...
          <Col className="gutter-row" span={10}>
            <div className="gutter-box" style={{
              ...
              <Menu style={{
                ...
                <SubMenu title={< Badge count = {
                  258
                } > <Icon type="setting"/> < /Badge>}>
                ...
                <SubMenu className="admin-user" title={< span > <Avatar icon="user" style={{
                  verticalAlign: 'middle'
                }}/> < span className = "user-name" style = {{ padding: "1.5rem .6rem" }} > zhoul < /span> <Icon type="down" / > </span>}>
