...
export default class SearchForm extends Component {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.submit.bind(this)} style={{ backgroundColor: '#fff', padding: '24px' }}>
        <Row gutter={26}>
          <Col span={6}>
          ...
          <Col span={8}>
            ...
            {getFieldDecorator('date', {
              ...
              <RangePicker style={{ width: '100%' }} size="large" showTime format="YYYY-MM-DD HH:mm:ss" />
            )}
            </FormItem>
          </Col>
          ...
          <Col span={4}>
            ...
            <Button size='large' style={{ marginLeft: 8 }} onClick={this.handleReset}> 清除</Button>
          </Col>
        </Row>

        <Row gutter={26}>
          <Col span={12}>
            <FormItem wrapperCol={{ span: 21 }} labelCol={{ span: 3 }} label='数据范围'>
